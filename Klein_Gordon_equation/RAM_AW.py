...
def draw_exact():
    ...
    plt.xlabel('$t$', fontsize=20)
    plt.ylabel('$x$', fontsize=20)
    plt.title(r'RAM-AW $u(x,t)$', fontsize=20)
    plt.tight_layout()
    plt.savefig('KG_pred_RAM-AW.pdf')
    plt.show()
...
def draw_residual():
    ...
    plt.tight_layout()
    plt.savefig('KG_residual-RAM-AW.pdf')
    plt.show()
...
def draw_error():
    ...
    plt.tight_layout()
    plt.savefig('KG_error-RAM-AW.pdf')
    plt.show()

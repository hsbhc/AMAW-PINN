...
def draw_exact():
    ...
    plt.xlabel('$x$', fontsize=20)
    plt.ylabel('$y$', fontsize=20)
    plt.title(r'PINN $Velocity$', fontsize=20)
    plt.tight_layout()
    plt.savefig('lid_driven_pred_PINN.pdf')
    plt.show()
...
def draw_exact_points(points, N_points=None, show_exact=True):
    ...
    plt.xlabel('$x$', fontsize=20)
    plt.ylabel('$y$', fontsize=20)
    plt.savefig('lid_driven_xnm-PINN.pdf')
    plt.show()
...
def draw_residual():
    ...
    plt.tight_layout()
    plt.savefig('lid_driven_residual-PINN.pdf')
    plt.show()
...
def draw_error():
    ...
    plt.tight_layout()
    plt.savefig('lid_driven_error-PINN.pdf')
    plt.show()
...
def draw_some_t():
    ...
    plt.tight_layout()
    plt.savefig('lid_driven_qie-PINN.pdf')
    plt.show()

...
def draw_exact():
    ...
    plt.xlabel('$x$', fontsize=20)
    plt.ylabel('$y$', fontsize=20)
    plt.title(r'RAM-AW $u(x,y)$', fontsize=20)
    plt.tight_layout()
    plt.savefig('Helmholtz_pred_RAM-AW.pdf')
    plt.show()
...
def draw_exact_points(points, N_points=None, show_exact=True):
    ...
    plt.xlabel('$x$', fontsize=20)
    plt.ylabel('$y$', fontsize=20)
    plt.savefig('Helmholtz_xnm-RAM-AW.pdf')
    plt.show()
...
def draw_residual():
    ...
    plt.tight_layout()
    plt.savefig('Helmholtz_residual-RAM-AW.pdf')
    plt.show()
...
def draw_error():
    ...
    plt.tight_layout()
    plt.savefig('Helmholtz_error-RAM-AW.pdf')
    plt.show()
...
def draw_epoch_w():
    ...
    plt.legend()
    plt.savefig('Helmholtz_S_RAM-AW.pdf', fontsize=20)
    plt.show()
...
def draw_some_t():
    ...
    plt.tight_layout()
    plt.savefig('Helmholtz_qie-RAM-AW.pdf')
    plt.show()

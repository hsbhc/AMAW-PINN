...
def draw_exact():
    ...
    plt.xlabel('$x$', fontsize=20)
    plt.ylabel('$y$', fontsize=20)
    plt.title(r'PINN $u(x,y)$', fontsize=20)
    plt.tight_layout()
    plt.savefig('Helmholtz_pred_PINN.pdf')
    plt.show()
...
def draw_exact_points(points, N_points=None, show_exact=True):
    ...
    plt.xlabel('$x$', fontsize=20)
    plt.ylabel('$y$', fontsize=20)
    plt.savefig('Helmholtz_xnm-PINN.pdf')
    plt.show()
...
def draw_residual():
    ...
    plt.tight_layout()
    plt.savefig('Helmholtz_residual-PINN.pdf')
    plt.show()
...
def draw_error():
    ...
    plt.tight_layout()
    plt.savefig('Helmholtz_error-PINN.pdf')
    plt.show()
...
def draw_some_t():
    ...
    plt.tight_layout()
    plt.savefig('Helmholtz_qie-PINN.pdf')
    plt.show()

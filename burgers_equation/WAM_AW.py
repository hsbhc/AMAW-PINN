...
def draw_exact():
    ...
    plt.tight_layout()
    plt.savefig('burgers_pred_WAM_AW.pdf')
    plt.show()
...
def draw_exact_points(points, N_points=None, show_exact=True):
    ...
    plt.xlabel('$t$', fontsize=20)
    plt.ylabel('$x$', fontsize=20)
    plt.savefig('burgers_xnm-WAM_AW.pdf')
    plt.show()
...
def draw_residual():
    ...
    plt.tight_layout()
    plt.savefig('burgers_residual-WAM.pdf')
    plt.show()
...
def draw_error():
    ...
    plt.tight_layout()
    plt.savefig('burgers_error-WAM.pdf')
    plt.show()
...
def draw_some_t():
    ...
    plt.savefig('burgers_qie_WAM_AW.pdf')
    plt.show()

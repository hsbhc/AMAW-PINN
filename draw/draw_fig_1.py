...
plt.tight_layout()
plt.savefig('fig_1_1.pdf')
plt.show()
# plt.savefig('fig_1_1.eps')
# plt.close()
...
# plt.ylim([-1.1, 1.1])
#
# plt.title('$P_{N_{rm}}$',fontsize = 20)
# plt.tight_layout()
# plt.savefig('fig_1_2.eps')
# plt.show()
# # plt.savefig('fig_1_1.eps')
# # plt.close()
#
# plt.plot(x_N[:, [0]], x_N[:, [1]], 'bx', markersize=4, clip_on=False)
# plt.xlabel('$x$',fontsize = 20)
# plt.ylabel('$y$',fontsize = 20)
# plt.axis('square')
# plt.xlim([-1.1, 1.1])
# plt.ylim([-1.1, 1.1])
# plt.title('$P_{N_{rn}}$',fontsize = 20)
# plt.tight_layout()
# plt.savefig('fig_1_3.eps')
# plt.show()
# # plt.savefig('fig_1_1.eps')
# # plt.close()
#
...
# plt.xlim([-1.1, 1.1])
# plt.ylim([-1.1, 1.1])
# plt.title('$P_{N_{r}}$',fontsize = 20)
# plt.tight_layout()
# plt.savefig('fig_1_4.eps')
# plt.show()
# # plt.savefig('fig_1_1.eps')
# plt.close()